...
def train_model_kfold(data, labels, k=10, num_epochs=300, batch_size=32, lr=0.001):
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(data)):
        ...
        model = BiLSTM(input_size, output_size).to(device)
        ...
        with torch.no_grad():
            for X_batch, y_batch in val_loader:
                ...
                prob = torch.softmax(outputs, dim=1)[:, 1]  # Probability for positive class
...
if __name__ == '__main__':
    ...
    data_file = '../ReSampling/NCRCC/esm2_features_train_NCRCC.csv'  # Path to your training CSV file
